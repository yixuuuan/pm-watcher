...
- **平台校准**：一张校准曲线图，外加五个平台的 **Brier 准确度排行**——小组赛阶段谁定价最准。
- 每张卡片一句**可传播的标题**——有差异、不套模板、双语（英文大字标题，中文模式下附中文小字），例如「全网看好，集体翻车」。
- 横向**日期标签**，点哪天看哪天。
...
- 一个 **意外指数**（S / A / B / C，0–100）与一个巨大的 **±% 偏差**数字：市场对这支球队的定价偏离真实结果有多远。*它衡量的是「市场看走眼的程度」，不是球队实力。*
